          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2.5">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-2xl bg-white dark:bg-black border border-[#E5E7EB] dark:border-gray-700 font-extrabold text-xs text-[#111827] dark:text-white hover:bg-gray-50 dark:hover:bg-gray-900 shadow-sm flex items-center justify-center gap-3 transition-all hover:scale-[1.01]"
              >
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-2xl bg-[#1877F2] hover:bg-[#166fe5] font-extrabold text-xs text-white shadow-sm flex items-center justify-center gap-3 transition-all hover:scale-[1.01]"
              >
              ...
              <button
                type="button"
                onClick={() => { setTab('phone'); setOtpStep('send'); setErrorMessage(''); setSuccessMessage(''); }}
                className="w-full py-3 px-4 rounded-2xl bg-[#F8FAFC] dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 border border-[#E5E7EB] dark:border-gray-700 font-extrabold text-xs text-[#111827] dark:text-white shadow-sm flex items-center justify-center gap-3 transition-all hover:scale-[1.01]"
              >
