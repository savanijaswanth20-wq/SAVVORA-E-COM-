...
from models.models import User, Category, Product, Inventory, Supplier, Coupon, Order, OrderItem, Payment, UserRole
...
def seed_data():
    ...
    products_data = [
        {
            ...
            "stock": 3, # 3 Left as per user layout!
            "featured": True
        },
        {
            ...
            "stock": 2, # 2 Left as per user layout!
            "featured": True
        },
        {
            ...
            "stock": 5, # 5 Left as per user layout!
            "featured": True
        },
        {
    ...
    # 6. Sample Demo Orders for Dashboard Revenue (Matching prompt ₹85,400 today revenue & 126 orders demo numbers!)
    o1 = Order(
    ...
    db.commit()
    db.close()
    print("StockFlow Database successfully seeded!")
